...
// создание объекта rental-аренда 
...
if (
    ...
    if($rental->create()){
        ...
        echo json_encode(array("message" => "запись была добавлена."), JSON_UNESCAPED_UNICODE);
    }

    // если не удается добавить завись, сообщим пользователю 
    else {
